...
exports.simpleParser = exports.htmlParser = exports.fullParser = void 0;
...
function htmlParser(input, opts) {
    const result = parser_1.language.htmlParser.handler(input, 0, {
        nestLimit: (opts.nestLimit != null) ? opts.nestLimit : 20,
        depth: 0,
        linkLabel: false,
        trace: false,
