...
exports.extract = exports.inspect = exports.toString = exports.parseSimple = exports.parseHtml = exports.parse = void 0;
...
exports.parse = parse;
function parseHtml(input, opts = {}) {
    const nodes = (0, internal_1.htmlParser)(input, {
        nestLimit: opts.nestLimit,
    });
    return nodes;
}
